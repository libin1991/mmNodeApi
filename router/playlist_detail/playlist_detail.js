...
const { formatData } = require('../../model/playlist_detail')
...
module.exports = async (ctx, next) => {
    ...
    if (musicType === QQ.mmConfig.musicType) {
        ...
        await axios
            .qq('https://c.y.qq.com/qzone/fcg-bin/fcg_ucc_getcdinfo_byids_cp.fcg', 'get', params)
            .then(res => {
        ...
        await axios
            .netease('http://music.163.com/weapi/v3/playlist/detail', 'post', params)
            .then(res => {
